...
public class ProviderLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton = findViewById(R.id.btnProviderLogin);
        registerButton = findViewById(R.id.btnProviderRegister);
        ...
        auth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        Intent i = new Intent(ProviderLoginActivity.this, providerUserInterfaceHome.class);
    ...
    private void openRegisterScreen() {
        Intent i = new Intent(ProviderLoginActivity.this, RegisterActivity.class);
        startActivity(i);
    }
}
