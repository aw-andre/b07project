...
public class providerUserInterfaceHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button sharedPatientsBtn = findViewById(R.id.buttonSharedPatients);
        Button viewReportBtn = findViewById(R.id.buttonViewReport);

        sharedPatientsBtn.setOnClickListener(v ->
